...
namespace DatabaseModels.Migrations
{
    ...
    [Migration("20250115092822_AddedEmailRequest")]
    partial class AddedEmailRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseModels.Models.ProductDetails", b =>
                {
                    ...
                    b.Property<int>("CareAndAdviceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabaseModels.Models.CareAndAdvice", b =>
                {
                    b.HasOne("DatabaseModels.Models.ProductDetails", "ProductDetails")
                        .WithOne("CareAndAdvice")
                        .HasForeignKey("DatabaseModels.Models.CareAndAdvice", "ProductDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DatabaseModels.Models.Description", b =>
                {
                    b.HasOne("DatabaseModels.Models.ProductDetails", "ProductDetails")
                        .WithOne("Description")
                        .HasForeignKey("DatabaseModels.Models.Description", "ProductDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DatabaseModels.Models.ProductDetails", b =>
                {
                    b.HasOne("DatabaseModels.Models.Product", "Product")
                        ...
                        .HasForeignKey("DatabaseModels.Models.ProductDetails", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DatabaseModels.Models.ProductInformation", b =>
                {
                    b.HasOne("DatabaseModels.Models.ProductDetails", "ProductDetails")
                        ...
                        .HasForeignKey("DatabaseModels.Models.ProductInformation", "ProductDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
